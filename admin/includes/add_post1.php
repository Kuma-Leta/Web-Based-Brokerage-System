...
$uploadDir = "images/"; // Directory to store uploaded photos
    ...
    $post_image = $_FILES['photos']['name'][$i];
    $fileTmp = $_FILES['photos']['tmp_name'][$i];
   

    move_uploaded_file($fileTmp, "../images/$post_image");

       // insert the photo data into the database
       $sql = "INSERT INTO properties(post_image) VALUES ('$post_image')";
    ...
    //   move_uploaded_file($post_image_tmp, "../images/$post_image");
       ...
       $query = "INSERT INTO properties(post_title, post_user, post_date, 
                    post_content, post_tags, post_status) VALUES( 
                    '$post_title', 
                    '$post_user', now(), '$post_content', '$post_tags',  
                    '$post_status')";
